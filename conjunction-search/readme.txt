...
26464tle.txt - C2 TLEs between 2010-10-01 and 2011-12-01 (I think) - necessary to run 'conj_gen.py'
...
whisper-conj.ipynb - outputs all close approaches where WHISPER data is also available
c1-conj.ipynb - finds the satellite that C1 had a close miss with in 2022 to verify the method
...
whi_conj_200.pkl - list of all close approaches (<200 km) where WHISPER data is also available
